                    ...
                    if (d->vi->format->bytesPerSample == 1) {
                        ...
                        for (int y = 0; y < h; y++) {
                            for (int xiter = 0; xiter < w; xiter += sizeof(__m128i)) {
                                ...
                                __m128i tmp2hi = _mm_add_epi16(_mm_add_epi16(_mm_mulhi_epi16(tmp1hi, mergeweight), _mm_srli_epi16(_mm_mullo_epi16(tmp1hi, mergeweight), 15)), srcreg1hi);
